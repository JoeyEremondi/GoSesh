...
func A_main(args []string) {
	...
	case "B-Fail":
		...
		bCommitBuf := checker.PrepareSend("Telling B to Abort", "ABORT")
	...
	case "B-Commit":
		...
		case "C-Commit":
			...
			//////////////////////////////////////////
			// Test: sending the wrong sort, should cause an error
			bCommitBuf := checker.PrepareSend("Telling B To Commit", "COMMIT")
			checker.WriteToUDP("127.0.0.1:24602", writeFun, bCommitBuf, addrMaker)
