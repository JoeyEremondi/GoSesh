...
func A_main(args []string) {
	...
	////////////////////////////////////////////
	// Test: Send to ourselves instead of B, should cause an error
	bStartBuf := checker.PrepareSend("Sending B Commit Req", 0)
	checker.WriteToUDP("127.0.0.1:24601", writeFun, bStartBuf, addrMaker)
...
func B_main(args []string) {
	...
	////////////////////////////////////////////
	// Test: Receive on C's channel, should cause an error
